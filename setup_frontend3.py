...
"""
os.makedirs("frontend/app/reset-password", exist_ok=True)
with open("frontend/app/reset-password/page.tsx", "w", encoding="utf-8") as f: f.write(reset_page)

dashboard_page = """import Link from 'next/link';
...
"""
with open("frontend/app/dashboard/page.tsx", "w") as f: f.write(dashboard_page)
